...
const I18N = {
  ...
  id: {
    ...
    backToHome: 'Kembali',
    scanToConnect: 'Scan untuk terhubung, berlaku',
    userLabel: 'User',
    purchasedAtLabel: 'Purchased At',
  ...
  jw: {
    ...
    backToHome: 'Mbalik',
    scanToConnect: 'Scan kanggo nyambung, sah suwene',
    userLabel: 'Pangguno',
  ...
  <div class="voucher-card" id="voucher-card-${escapeHtml(idSuffix)}">
    <div class="left">
      <div>
        ...
        <div class="text-xs text-ink-soft mt-1">${t('voucherCardSubtitle')}</div>
      </div>
      <div class="mt-4">
